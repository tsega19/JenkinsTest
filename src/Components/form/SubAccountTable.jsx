...
export function SubAccountTable() {
    return (<TableContainer component={Paper} className="p-10" style={{ boxShadow: "none" }}>
      <Table aria-label="simple table">
        ...
        <TableBody>
          {rows.map((row) => (<TableRow key={row.name} sx={{ borderBottom: "none", boxShadow: "none" }}>
...
//# sourceMappingURL=SubAccountTable.jsx.map