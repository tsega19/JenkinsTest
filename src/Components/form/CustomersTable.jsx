...
function createData(Since, LastTxnDate, CustomerName, Email, Phone, TxnCount, TotalTxnAmount) {
    return {
        Since,
        LastTxnDate,
        CustomerName,
...
const rows = [
    createData("2023/1/3", "2023/1/3", "John Doe", "3qoE5@example.com", 1234567890, "10", "2000"),
    createData("2023/1/3", "2023/1/3", "John Doe", "3qoE5@example.com", 1234567890, "10", "2000"),
];
export default function DenseTable() {
    return (<TableContainer component={Paper} sx={{ width: "100%", overflowX: "auto" }}>
      <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
        ...
        <TableBody>
          {rows.map((row, key) => (<TableRow key={key} sx={{ height: "50px" }}>
...
//# sourceMappingURL=CustomersTable.jsx.map