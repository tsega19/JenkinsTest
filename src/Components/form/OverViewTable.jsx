...
function createData(date, customer, transactionAmount, transactionThrough, commission) {
...
export default function OverViewTable() {
    return (<TableContainer component={Paper}>
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        ...
        <TableBody>
          {rows.map((row) => (<TableRow key={row.date} sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
...
//# sourceMappingURL=OverViewTable.jsx.map