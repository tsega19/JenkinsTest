...
export const AccountSetting = () => {
  ...
  } = useForm<TBankAccountSchema>({
    resolver: zodResolver(BankAccountSchema),
  });

  const onSubmit = async (data: TBankAccountSchema) => {
    try {
      if (userToken) {
        ...
        <div className="modal-box">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="">
              ...
              />
              {errors.holderName && (
                <p className="text-red-500 p-1">{errors.holderName.message}</p>
              )}
              ...
              />
              {errors.bank && (
                <p className="text-red-500 p-1">{errors.bank.message}</p>
              )}
