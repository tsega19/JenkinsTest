...
function CurrencyTab(props) {
    ...
    return (<Box sx={{ display: "flex", justifyContent: "space-between", width: "30rem" }}>
      <Typography variant="h6" sx={{ pt: "5px" }}>
        {currencyBalance.currency}: {currencyBalance.amount}
      </Typography>
      <TextField id="standard-basic" placeholder="Amount Field to Withdraw" sx={{ fontSize: "1px" }} variant="standard"/>
...
//# sourceMappingURL=Balance.jsx.map