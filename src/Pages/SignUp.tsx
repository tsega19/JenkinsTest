...
import { TSignUpSchema, signUpSchema } from "../lib/validator";
    ...
    <>
      <section className="w-full flex justify-center items-center my-10">
        <div className="absolute text-primary  left-0 top-0 p-10">
          <h1
            className="text-3xl font-medium cursor-pointer z-10 text-white"
            onClick={() => navigate("/")}
          >
            Kispay
          </h1>
        ...
        <div className="shadow-xl bg-white w-[90%] xl:w-[40%] lg:w-[40%] md:w-[50%]  px-5 p-5 rounded-lg z-10 ">
          ...
          <div className="mt-10 sm:mx-auto ">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div className="sm:flex sm:justify-between">
                ...
                <div className="sm:w-[32%] mt-6 sm:mt-0">
                  ...
                  <input
                    ...
                    type="text"
                    className={`block w-full rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ${
                      errors.middleName ? "ring-red-500" : "ring-gray-300"
                    } placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-2`}
                    id="middleName"
                  />
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  className={`block w-full rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ${
                    errors.businessName ? "ring-red-500" : "ring-gray-300"
                  } placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-2`}
                  id="businessName"
                />
              </div>
              ...
              <div className="flex items-center mt-5">
                ...
                <label
                  ...
                  className={`text-sm  cursor-pointer ml-5 ${
                    errors.agreement ? "text-red-500" : "text-gray-900"
                  }`}
                >
              ...
              {errors.agreement && (
                <div className="text-red-500">{errors.agreement.message}</div>
              )}
              <button
                type="submit"
                className="w-full py-2 text-sm font-semibold text-white bg-primary rounded-md hover:bg-primary/60 focus:outline-none"
              >
            ...
            <p className="mt-8 text-center text-sm text-gray-500">
              ...
              <a
                href="#"
                className="font-semibold leading-6 text-neutral-800 hover:text-secondary p-10 hover:underline"
