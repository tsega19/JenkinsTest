          ...
          <Box sx={{
            ...
            <div className="bg-white w-full sm:w-[25vw] shadow-xl rounded-lg p-4 relative" ref={modalRef}>
              ...
              <div className="flex flex-col items-center gap-4 mt-4">
                <input type="text" placeholder="Donation Campaign Name" className="bg-gray-200 rounded-md w-full p-2 focus:outline-none"/>
                <div className="flex items-center w-full relative">
                  <input type="text" placeholder="Donation Amount" className="bg-gray-200 rounded-md w-full p-2 focus:outline-none"/>
                ...
                <textarea placeholder="Purpose of Donation for Campaign" className="bg-gray-200 rounded-md w-full p-2 focus:outline-none"></textarea>
