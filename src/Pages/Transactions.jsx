    ...
    return (<>
      <section className="p-4 md:p-10 -z-10">
        <div className="flex flex-wrap gap-4">
          <div className="flex gap-2">
            <select value={optionValue} onChange={(e) => setOptionValue(e.target.value)} className="md:px-6 py-1 border border-gray-300 rounded-md text-neutral-800 focus:outline-none text-sm">
            ...
            <div className="flex items-center gap-2 relative w-full md:w-auto">
              ...
              <input type="text" placeholder={`please enter ${optionValue}`} className="pl-10 pr-4 py-2 w-full md:w-auto border border-gray-300 rounded-md focus:outline-none text-sm"/>
            </div>
        ...
        }} value={from} onChange={(newValue) => setFrom(newValue)}/>
        ...
        }} value={to} onChange={(newValue) => setTo(newValue)}/>
            </DemoContainer>
      ...
      <section className="relative">
        ...
        <div className="flex justify-end md:justify-end items-center gap-4 p-8">
          <TbPlayerTrackPrev size="1.8rem" className="text-gray-400 cursor-pointer"/>
          <TbPlayerTrackNext size="1.8rem" className="text-gray-400 cursor-pointer"/>
        </div>
      </section>
    </>);
};
//# sourceMappingURL=Transactions.jsx.map